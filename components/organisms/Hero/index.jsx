...
export const Hero = () => {
  ...
  useEffect(() => {
    ...
    tl.to(heroRef.current, { duration: 0.5, y: 0, opacity: 1})
      .to(containerImg.current, { duration: 0.5, visibility: "visible" }, "-=1.3")
  ...
  return (
    <section className="relative flex flex-row min-h-screen w-full" >
      <div className="relative max-w-7xl 2xl:max-w-[1440px] w-full md:w-11/12 lg:w-4/5 mx-auto flex flex-col justify-center px-6 md:px-5 z-10 -translate-y-20 opacity-0" ref={heroRef}>
