...
export const Hero = () => {
  ...
  useEffect(() => {
    ...
    tl.to(heroRef.current, { duration: 0.5, y: 0})
  ...
  return (
    <section className="relative flex flex-row min-h-screen w-full" >
      <div className="relative max-w-7xl 2xl:max-w-[1440px] w-full md:w-11/12 lg:w-4/5 mx-auto flex flex-col justify-center px-6 md:px-5 z-10 translate-y-60" ref={heroRef}>
