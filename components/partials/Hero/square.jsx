...
export const Square = () => {
    ...
    const handleMove = e => {
        const x = (window.innerWidth - e.mouse.x ) / 120;
        const y = (window.innerHeight - e.clientY ) / 120;
    };
    ...
    return (
        <div className="w-full min-h-screen h-full flex items-center" onMouseMove={e => handleMove(e)} >
            <svg viewBox="0 0 1582 747" fill="none" xmlns="http://www.w3.org/2000/svg" ref={(el) => moveSquare = el} className="w-full h-full max-w-[1550px] mx-auto ">
