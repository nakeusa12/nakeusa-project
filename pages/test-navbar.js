    ...
    <>
      ...
      <main className="">
        <nav
          className={`w-full ${
            openMenu
              ? "bg-blue-200 md:bg-transparent min-h-screen md:min-h-full"
              : "bg-transparent"
          } flex items-center md:justify-between md:px-36 px-12 flex-col md:flex-row fixed`}
        >
          <div className="w-full md:w-auto flex items-center justify-between h-[88px]">
            ...
            <div className="md:hidden block" onClick={handleMenu}>
              {openMenu ? (
                ...
                <div className="w-5 h-6 bg-blue-500"></div>
              )}
            </div>
          </div>
          <div
            ...
            } flex-col md:flex-row justify-center items-center gap-7 navbar-item`}
          >
            <Link href={"/"}>
              <a>Home</a>
            </Link>
...
const GalleryItem = ({
    ...
    return (
      <div
        ...
        className={cn("gallery-item-wrapper aspect-video h-full grid grid-cols-[20vw_1fr_300px] w-screen", { "is-reveal": onScreen })}
        ref={ref}
      >
        <div></div>
        <div className={"w-full h-full relative will-change-transform"}>
          <div className="absolute bottom-[10%] z-[1] translate-x-[-20%] text-white">
            <h1 className="text-[6vw] font-semibold">{title}</h1>
            <h2 className="gallery-info-subtitle">{subtitle}</h2>
            <p className="gallery-info-category">{category}</p>
          </div>
          <div
            className={`gallery-item-image bg-cover bg-center origin-center w-full h-full will-change-transform scale-75 transition-all duration-1000 grayscale sepia-[20%] brightness-[80%] ease-in-out`}
...
const Gallery = ({ src, index, columnOffset }) => {
  ...
  const [activeImage, setActiveImage] = useState(1);
    ...
    return (
      <section data-scroll-section className="section-wrapper bg-red-500">
